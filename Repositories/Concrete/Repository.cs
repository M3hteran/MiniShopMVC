...
namespace MiniShopMVC.Repositories.Concrete
{
	public class Repository<T> : IRepository<T> where T : class
	{
		...
		public async Task<T?> FirstOrDefaultWithIncludesAsync(Expression<Func<T, bool>> predicate, params string[] includes)
		{
